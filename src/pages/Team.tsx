                ...
                <React.Fragment key={member.id}>
                    ...
                    <div
                        className="w-72 rounded-md text-center shadow-lg p-6 transition-all duration-500 ease-in-out
                                bg-[#3BB6DA] hover:bg-gradient-to-b hover:from-[#79C8F1] hover:to-[#E6F6FE] group"
                    >
                        <img
                        src={member.photo}
                        alt={member.name}
                        ...
                        {/* Always visible email icon */}
                        <a href={`mailto:${member.email}`} className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-black">
                            ✉️
                        </a>
                        ...
                        <a
                            ...
                            className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-black"
                        >
                            in
                        </a>
                        </div>
