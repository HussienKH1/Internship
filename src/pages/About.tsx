  ...
  return (
    <div className="font-inter">
      ...
      <section className="py-16 bg-white text-center">
        <h2 className="text-3xl font-bold mb-4 text-red-600">Our Clients Says</h2>
          ...
          {testimonials.map((t) => (
            <div key={t.id} className="border rounded-lg p-6 relative">
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white px-2">
                <FontAwesomeIcon icon={faQuoteLeft} className="text-red-600 text-3xl" />
              </div>
              <img
                src={t.image}
                alt={t.name}
              ...
              <span className="text-red-600 text-sm">{t.role}</span>
            </div>
          ))}
        </div>
